...
/*
*/
class ReverbController : public TextButton
{
public:
    /** @constructor */
    ReverbController(const std::string& buttonName);

    /** @descructor */
    ~ReverbController() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ReverbController)
};
